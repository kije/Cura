...
Item
{
    ...
    property bool isFreehand: currentDrawingMode === Cura.PaintToolDrawingMode.FREEHAND
    property bool isLine: currentDrawingMode === Cura.PaintToolDrawingMode.LINE
    property bool isFill: currentDrawingMode === Cura.PaintToolDrawingMode.FILL
    ...
    Column
    {
        ...
        GridLayout
        {
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.FREEHAND
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.LINE
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.RECTANGLE
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.CIRCLE
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.POLYGON
            ...
            DrawingToolButton
            {
                drawingMode: Cura.PaintToolDrawingMode.FILL
